...
- **Маршрутизация по странам**: Исключение российских IP из прокси/туннеля
...
2. Выбор исключений по странам (ru, ua и т.д.)
...
Маршрутизирует трафик от указанных LAN-клиентов через туннели OpenVPN/WireGuard в зависимости от назначения. По умолчанию исключает российские IP для прямого доступа к локальным сервисам.
